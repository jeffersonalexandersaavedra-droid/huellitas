...
export default function ModalPagoYape({
  ...
  function handleCopiar() {
    navigator.clipboard?.writeText(YAPE.numero.replace(/\s/g, ""));
    setCopiado(true);
        ...
        <div className="max-h-[65vh] space-y-6 overflow-y-auto p-5">
          <div>
            <p className="text-sm font-medium text-huellitas-ink">
              1. Realiza el pago desde tu app de Yape o Plin
            </p>
          ...
          <div>
            <p className="text-sm font-medium text-huellitas-ink">2. Sube tu voucher del pago</p>
            {voucherFile ? (
